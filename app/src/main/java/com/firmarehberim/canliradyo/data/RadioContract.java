...
public final class RadioContract {
    ...
    public static final class RadioEntry implements BaseColumns {
        ...
        public static final String COLUMN_IS_BEING_BUFFERED = "is_being_buffered";
        public static final String COLUMN_IS_LIKED = "is_Liked";
        public static final String COLUMN_NAME = "name";
        public static final String COLUMN_SHAREABLE_LINK = "shareable_link";
        public static final String COLUMN_STREAM_LINK = "stream_link";
        public static final String COLUMN_IS_IN_HLS_FORMAT = "is_in_hls_format";
