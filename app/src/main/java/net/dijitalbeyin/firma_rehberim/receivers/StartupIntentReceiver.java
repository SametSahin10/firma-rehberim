package net.dijitalbeyin.firma_rehberim.receivers;
...
import static net.dijitalbeyin.firma_rehberim.activities.OverlayActivity.SERVICE_RUNNING;
import static net.dijitalbeyin.firma_rehberim.activities.OverlayActivity.serviceState;
